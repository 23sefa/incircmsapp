	...
	<div class="content">
		<div class="panel">
			<div class="content-header no-mg-top">
				...
				<div class="content-header-title">Gruplar</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-6">
									<button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Yeni Grup Ekle</button>
								</div>
								<div class="col-md-6 form-inline justify-content-end">
									<select class="form-control mb-1 mr-sm-1 mb-sm-0" id="search-option"></select>
									<input class="form-control" id="search" placeholder="Aranacak kelime" type="text">
								</div>
							</div>
						</div>
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		...
		columns					: [
		{field: 'group_name', title: 'Grup Adı', editable: true, sortable: true, width: 450, align: 'left', search: true},
		{field: 'menu', title: 'İşlem', sortable: false, width: 200, align: 'center', search: false, 
	...
	function menu(rowData, rowIndex) {
		var menu = '<a href="javascript:;" onclick="main_routes(\'update\', ' + rowIndex + ')"><i class="fa fa-pencil"></i> Düzenle</a> ' +
		'<a href="javascript:;" onclick="delete_action(' + rowIndex + ')"><i class="fa fa-trash-o"></i> Sil</a>'
		return menu;
	}
