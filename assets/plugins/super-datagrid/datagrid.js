(function ( $ ) {
	...
	$.fn.datagrid = function(options) {
		...
		function PagingData(activePageNumber, itemsPerPage) {
			...
			// First
    		var first_template = $('<li><a href="javascript:void(0);">İlk</a></li>')
    		...
    		// Prev
    		var prev_template = $('<li><a href="javascript:void(0);">Önceki</a></li>')
    		if (activePageNumber > 1) {
    		...
    		// Next
    		var next_template = $('<li><a href="javascript:void(0);">Sonraki</a></li>')
    		...
    		// Last
    		var last_template = $('<li><a href="javascript:void(0);">Son</a></li>')
    		if (activePageNumber < total_page) {
	    ...
	    function PageInfo(activePageNumber, itemsPerPage) {
	    	...
	    	if (data.total >= 1) {
				...
				$(config.pageInfoElement).html(data.total + ' veriden ' + limit + ' ile ' + offset + ' arası sonuçlar gösteriliyor');
	    	} else {
	    		$(config.pageInfoElement).html('Veri Bulunamadı');
	    	}
	    }
